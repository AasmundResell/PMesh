...
### Create Export
Export_1 = model.exportToXAO(Part_1_doc, '/tmp/shaper_28fl91qb.xao', model.selection("FACE", "Revolution_1_1"), 'XAO')

### Create Export
Export_2 = model.exportToXAO(Part_1_doc, '/tmp/shaper_71fo47n9.xao', model.selection("FACE", "Revolution_1_2"), 'XAO')
...
### Create Export
Export_16 = model.exportToXAO(Part_1_doc, '/tmp/shaper_owcdxn40.xao', model.selection("FACE", "Revolution_3_3"), 'XAO')
...
# Fuse_1_1, = SHAPERSTUDY.shape("dead01_8:35")
...
(imported, geomObj_1, [], [], []) = geompy.ImportXAO("/tmp/shaper_piptj80y.xao")
(imported, Revolution_1_1, [], [], []) = geompy.ImportXAO("/tmp/shaper_28fl91qb.xao")
(imported, Revolution_1_2, [], [], []) = geompy.ImportXAO("/tmp/shaper_71fo47n9.xao")
...
(imported, geomObj_2, [], [], []) = geompy.ImportXAO("/tmp/shaper_v0aajww7.xao")
(imported, geomObj_3, [], [], []) = geompy.ImportXAO("/tmp/shaper_783ep9h9.xao")
(imported, geomObj_4, [], [], []) = geompy.ImportXAO("/tmp/shaper_viudf5nu.xao")
(imported, geomObj_5, [], [], []) = geompy.ImportXAO("/tmp/shaper__smva8a_.xao")
(imported, geomObj_6, [], [], []) = geompy.ImportXAO("/tmp/shaper_kf23e2vv.xao")
(imported, geomObj_7, [], [], []) = geompy.ImportXAO("/tmp/shaper_dsa4ng_i.xao")
(imported, geomObj_8, [], [], []) = geompy.ImportXAO("/tmp/shaper_k0mj7iks.xao")
(imported, geomObj_9, [], [], []) = geompy.ImportXAO("/tmp/shaper_owcdxn40.xao")
(imported, geomObj_10, [], [], []) = geompy.ImportXAO("/tmp/shaper_7h2jxb7u.xao")
(imported, geomObj_11, [], [], []) = geompy.ImportXAO("/tmp/shaper_tnogw0ii.xao")
(imported, geomObj_12, [], [], []) = geompy.ImportXAO("/tmp/shaper_ics86ksd.xao")
(imported, geomObj_13, [], [], []) = geompy.ImportXAO("/tmp/shaper_eulypudq.xao")
(imported, geomObj_14, [], [], []) = geompy.ImportXAO("/tmp/shaper_h0kmr3z4.xao")
(imported, geomObj_15, [], [], []) = geompy.ImportXAO("/tmp/shaper_ab3bkn1g.xao")
(imported, geomObj_16, [], [], []) = geompy.ImportXAO("/tmp/shaper_4lcc4u40.xao")
(imported, geomObj_17, [], [], []) = geompy.ImportXAO("/tmp/shaper_2rkeu0_3.xao")
Projectile_nose = geompy.CreateGroup(Revolution_1_1, geompy.ShapeType["FACE"])
geompy.UnionIDs(Projectile_nose, [1])
...
back_end = geompy.CreateGroup(Revolution_3_3, geompy.ShapeType["FACE"])
geompy.UnionIDs(back_end, [1])
...
geompy.addToStudyInFather( Revolution_1_1, Projectile_nose, 'Projectile_nose' )
geompy.addToStudyInFather( Revolution_2_2, section_1, 'section_1' )
geompy.addToStudyInFather( Revolution_3_2, section_2, 'section_2' )
geompy.addToStudyInFather( Revolution_3_3, back_end, 'back_end' )
