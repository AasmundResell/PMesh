...
hei = geompy.SubShapeAllIDs(Domain,geompy.ShapeType["FACE"])
print("Sub Shapes: ",hei)
...
id1 = geompy.GetSameIDs(Revolution_1_1, Nose)
id2 = geompy.GetSubShapeID(Revolution_1_1, Nose)
...
id_p0 = geompy.addToStudy( Domain, 'Domain' )
geompy.addToStudyInFather( Domain, Farfield, 'Farfield' )
geompy.addToStudyInFather( Domain, Rocket_1, 'Rocket' )

domain_faces = geompy.SubShapeAllSortedCentres(Domain, geompy.ShapeType["FACE"])

f_ind_1 = geompy.GetSubShapeID(Domain, domain_faces[1])
print("Faces domain: ",f_ind_1)
...
#NETGEN_2D_Parameters_1.UnsetLocalSizeOnEntry("Nose")
#NETGEN_2D_Parameters_1.UnsetLocalSizeOnEntry("section_1")
#NETGEN_2D_Parameters_1.UnsetLocalSizeOnEntry("section_2")
#NETGEN_2D_Parameters_1.UnsetLocalSizeOnEntry("back")
...
#NETGEN_2D_Parameters_1.UnsetLocalSizeOnEntry("section_2")
#NETGEN_2D_Parameters_1.UnsetLocalSizeOnEntry("back")
Viscous_Layers_2D_1.SetTotalThickness( 1.5 )
Viscous_Layers_2D_1.SetNumberLayers( 20 )
Viscous_Layers_2D_1.SetStretchFactor( 1.2 )
Viscous_Layers_2D_1.SetEdges( [ 5, 7, 9 ], 1 )
Viscous_Layers_1.SetTotalThickness( 1.5 )
Viscous_Layers_1.SetNumberLayers( 20 )
Viscous_Layers_1.SetStretchFactor( 1.2 )
Viscous_Layers_1.SetMethod( smeshBuilder.SURF_OFFSET_SMOOTH )
Viscous_Layers_1.SetFaces( [3,10,12], 1 )
