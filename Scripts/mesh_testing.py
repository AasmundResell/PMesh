...
domain = geompy.MakeCutList(Outer_domain, [Projectile], True)
geomObj_2 = geompy.GetInPlace(domain, ShellProjectile, True)
[geomObj_3,geomObj_4,geomObj_5,geomObj_6,geomObj_7] = geompy.SubShapeAll(geomObj_2, geompy.ShapeType["FACE"])
[geomObj_8,geomObj_9,geomObj_10,geomObj_11,geomObj_12] = geompy.SubShapeAll(geomObj_2, geompy.ShapeType["FACE"])
projectile = geompy.CreateGroup(domain, geompy.ShapeType["FACE"])
geompy.UnionIDs(projectile, [15, 19, 24, 29, 34])
geomObj_13 = geompy.GetInPlace(domain, Outer_domain, True)
[geomObj_14,geomObj_15,geomObj_16,geomObj_17,geomObj_18,geomObj_19,geomObj_20,geomObj_21] = geompy.SubShapeAll(geomObj_13, geompy.ShapeType["FACE"])
[geomObj_22,geomObj_23,geomObj_24,geomObj_25,geomObj_26,geomObj_27,geomObj_28,geomObj_29] = geompy.SubShapeAll(geomObj_13, geompy.ShapeType["FACE"])
...
geompy.addToStudyInFather( domain, projectile, 'projectile' )
